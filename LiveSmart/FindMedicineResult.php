...
$retval = mysql_query( "SELECT * FROM medicine WHERE Medicine_Name LIKE '$pickup' ", $dbc );
...
while($row = mysql_fetch_array($retval, MYSQL_ASSOC))
{
	...
	echo "<tr><td>".$row["Medicine_Name"]."</td><td>".$row["Compositions"]."</td><td> ".$row["Symptoms"]."</td><td>".$row["BrandName"]."</td><td>".$row["Price"]."</td></tr>";
...
echo "<br><br>";
echo '<center><a href="FindMedicine.html" class="btn btn-lg btn-warning">Make New Search</a></center>';
