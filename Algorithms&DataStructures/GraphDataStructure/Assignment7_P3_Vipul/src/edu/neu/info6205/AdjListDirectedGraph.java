...
public class AdjListDirectedGraph {
	...
	public AdjListDirectedGraph(int edgeCount, int verticesCount) {
	...
	public void printAdjacencyList() {
		System.out.println("AdjacencyList elements in case of Directed Graph for above vertices in Order:");
		Iterator<Integer> it  = verticesSet.iterator();
		while(it.hasNext()) {
